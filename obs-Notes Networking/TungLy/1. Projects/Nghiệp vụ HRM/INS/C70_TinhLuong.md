...
**C70 – Tính Lương** là quy trình tính toán lương và các khoản liên quan (bảo hiểm, thuế TNCN, phụ cấp...) trong hệ thống **HRM (FIT-HRM / Bizzi)**. Đây là quy trình trung tâm của module **INS (Insurance)** và **Payroll**, được thực hiện định kỳ hàng tháng.
