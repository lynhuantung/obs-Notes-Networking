...
# 📘 HƯỚNG DẪN TRIỂN KHAI HỆ THỐNG HRM QuickPack
...
|**File cấu hình**|`IIS-DB-QuickPack-config.rar`|Gồm cấu hình IIS, DB, Redis, URL các service|
|**Source HRM**|`QuickPack_v8.12.46.01.19.rar`|Mã nguồn hệ thống HRM|
...
1. Giải nén `HRMPRO12_QuickPack_20250423.rar`.
    
2. Restore database bằng SQL Server:

### ⚙️ Bước 2: Cấu hình Source HRM

1. Giải nén `QuickPack_v8.12.46.01.19.rar` vào `D:\QuickPack_HRM`.
...
```text
Data Source=103.127.207.231,2968;Initial Catalog=HRMPRO12_QuickPack;User ID=sa;Password=...;TrustServerCertificate=True;Persist Security Info=True
```
