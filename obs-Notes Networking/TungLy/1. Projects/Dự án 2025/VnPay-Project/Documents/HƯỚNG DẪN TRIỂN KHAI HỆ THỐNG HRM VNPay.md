...
Liên kết:
---
# 🛠️ HƯỚNG DẪN TRIỂN KHAI HỆ THỐNG HRM VNPay
...
|**File cấu hình**|`IIS-DB-VnPay-config.rar`|Bao gồm cấu hình IIS, DB connection|
|**Source HRM**|`VNPAY_v8.12.46.01.19.rar`|Source code hệ thống HRM|
...
1. Giải nén file `HRMPRO12_VNPAY_20250423.rar`.
...
1. Giải nén `VNPAY_v8.12.46.01.19.rar` vào thư mục ví dụ: `D:\VNPAY_HRM`.
