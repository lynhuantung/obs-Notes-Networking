...
![Drawing1](../../../../src/Ins_Kaizen_08_image2.png)
...
| **Trước kaizen** | ![](../../../../src/Ins_Kaizen_08_image3.png) Nhập công thức bằng textbox, thường xuyên gặp vấn đề không phân tích bảo hiểm thành công vì công thức sai. | | |
| **Sau kaizen** | ![](../../../../src/Ins_Kaizen_08_image4.png) Chuyển textbox thành combobox sẽ thuận tiện và chọn công thức chính xác hơn | | |
...
| **Trước kaizen** | ![](../../../../src/Ins_Kaizen_08_image5.png) Người dùng không biết cách cấu hình, cấu hình sai sẽ dẫn đến phân tích bảo hiểm không chính xác, D02 cũng không phân tích đúng | | |
| **Sau kaizen** | ![](../../../../src/Ins_Kaizen_08_image6.png) Tạo nút cấu hình mặc định (ở gốc trên bên phải màn hình), khi chọn cấu hình mặc định (và có thể phục hồi cấu hình như ban đầu), sau đó lưu. Khi phân tích bảo hiểm sẽ ra kết quả chính xác. | | |
...
| **Sau kaizen** | ![SNAGHTML3db7cfe4](../../../../src/Ins_Kaizen_08_image7.png) Tạo nút help (ở gốc trên bên phải màn hình), sau khi chọn icon help sẽ link đến màn hình hướng dẫn qui trình bảo hiểm. | | |
...
| **Sau kaizen** | ![](../../../../src/Ins_Kaizen_08_image8.png) Tạo một trang thể hiện tất cả các ngoại lệ phân tích bảo hiểm, người dùng có thể tham khảo, bao gồm giải pháp ứng phó ngoại lệ đó. | | |
...
| **Sau kaizen** | ![SNAGHTMLa6ab8aa](../../../../src/Ins_Kaizen_08_image9.png) Validate kiểm tra dữ liệu đầu vào trước, sau khi xuất thông báo dữ liệu đầu vào chưa đúng hoặc phát hiện ngoại lệ, sẽ xuất hiện link giải thích ngoại lệ và dẫn đến trang mô tả trục trặc phân tích bảo hiểm và highlight vào trục trặc đó. Validate các mục: Chức danh theo luật chưa có dữ liệu; Chức vụ theo luật chưa có dữ liệu; Nơi đóng BH chưa có dữ liệu; Chưa tổng hợp công. | | |
...
| **Sau kaizen** | ![9-5-2017 11-51-50 AM](../../../../src/Ins_Kaizen_08_image11.png) Sau khi người dùng kéo thanh cuộn dọc xuống 1 khoảng để phân quyền, button trở về đầu trang sẽ hiện lên, nếu click vào sẽ đưa thanh cuộn về đầu trang. | | |
...
| **Sau kaizen** | ![button_giup](../../../../src/Ins_Kaizen_08_image12.png) Thêm phần trợ giúp mô tả các cấu hình bảo hiểm. Sau khi click button trợ giúp, Popup mô tả thiết lập bảo hiểm sẽ hiện lên. ![button_giup_ra](../../../../src/Ins_Kaizen_08_image13.png) | | |
...
| **Sau kaizen** | ![qưeqweqweqweqweq](../../../../src/Ins_Kaizen_08_image14.png) Viết thêm tool tự động thay đổi web.config => Giảm bớt công việc, hạn chế tối đa lỗi xảy ra không đáng có, thao tác nhanh gọn, chính xác. | | |
...
| **Sau kaizen** | ![9-22-2017 3-31-00 PM](../../../../src/Ins_Kaizen_08_image15.png) Tạo thêm textbox tìm kiếm theo tên quyền tiếng việt hoặc key quyền | | |
...
| **Trước kaizen** | Trong màn hình phân tích bảo hiểm không hiển thị phần trăm ![](../../../../src/Ins_Kaizen_08_image16.png) | | |
| **Sau kaizen** | ![](../../../../src/Ins_Kaizen_08_image17.png) Hiển thị phần trăm màn hình phân tích bảo hiểm | | |
