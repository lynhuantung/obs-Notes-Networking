---
description: "Nghiên cứu chuyên sâu nghiệp vụ Bảo hiểm HRM: BHXH bắt buộc, BH tự nguyện, cải đặt tầng rầng MISA AMIS và pattern sử dụng từ nhiều dự án."
type: synthesis
tags:
  - research
  - bao-hiem
...
research-topic: Nghiệp vụ Bảo hiểm trong HRM
...
# Nghiên cứu: Nghiệp vụ Bảo hiểm trong HRM
...
HRM định nghĩa phân hệ Bảo hiểm gồm:
