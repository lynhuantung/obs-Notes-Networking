---
description: "Quy trình tính lương tháng HRM: chốt chấm công, xác định BH, chạy payroll engine, tổng hợp C70, duyệt lương và chuyển khoản nhân viên."
type: flow
tags:
  - luong
  - payroll
...
Quy trình tính lương tháng là nghiệp vụ **trọng tâm nhất** của HRM. Mọi phân hệ đều đổ dữ liệu vào đây. Lỗi ở bất kỳ bước nào đều ảnh hưởng đến lương nhân viên. Chu kỳ hàng tháng (đầu tháng sau), phân hệ liên quan: Chấm công → Bảo hiểm → Lương → Báo cáo.

## Mermaid Flow

```mermaid
flowchart TD
    A[Ngay 1-3 thang sau: Chot du lieu Cham cong Fingerprint Face ID OT]
    B[Xu ly Nghi phep Nghi om Thai san]
    C{Nghi om hoac Thai san?}
    D[Giu nguyen ban ghi BH: KHONG cat]
    E[InsuranceMonthJoin: Xac dinh thang tham gia BH]
    F[InsuranceRecordDayCount: Dem ngay dong BH thuc te]
    G[Payroll Engine: Tinh luong gross sang net]
    H[Tong hop C70: NLD 10.5% + NSDLD 21.5%]
    I[Kiem tra va Duyet luong: HR Manager sang CFO]
    J[Xuat bao cao va Chuyen khoan ngan hang]
    K[Khai bao D02 len cong iBHXH deadline ngay 25]
...
**Người thực hiện**: HR Admin | **Deadline**: Ngày 1–3 tháng sau
