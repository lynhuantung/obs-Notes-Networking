---
description: "Luồng phân tích bảo hiểm hàng tháng (INS01) trong HRM: cập nhật chứng từ, phân tích, xuất D02/C70A, chuyển số liệu sang lương."
type: flow
...
Luồng xử lý **phân tích bảo hiểm hàng tháng** trong HRM Pro. Diễn ra trước khi tính lương, chạy trong chu kỳ từ ngày 16 tháng N-1 đến ngày 15 tháng N.
...
flowchart TD
    ...
    A[INS01.01 Cập nhật chứng từ BHXH] --> B
    B{Đã tổng hợp công chưa?}
    B -- Chưa --> C[Tổng hợp công tháng N qua ATT]
    B -- Roi --> D
    C --> D
    D[INS01.02 Phân tích bảo hiểm] --> E
    E{Có lỗi phân tích?}
    E -- Có --> F[Chẩn đoán sự cố tại BH]
    E -- Không --> G
    F --> D
    G[INS01.03 Xuất báo cáo D02-TS C70A TK01 TK02] --> H
    H{Có phát sinh tăng giảm?}
    H -- Có --> I[Xuất D02-TS nộp trước ngày 20]
    H -- Không --> J
    I --> J
    J{Có chứng từ ốm đau hoặc thai sản?}
    J -- Có --> K[Xuất C70A nộp cho cơ quan BHXH]
    J -- Không --> L
    K --> L
    L[INS01.04 SAL Tính lương từ InsuranceMonthly] --> END
    END([Kết thúc])
```
