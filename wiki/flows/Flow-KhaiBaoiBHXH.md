---
description: "Quy trình khai báo BHXH điện tử (iBHXH) hàng tháng: tổng hợp dữ liệu, sinh file D02-TS, nộp cổng, theo dõi duyệt, deadline ngày 25."
type: flow
tags:
  - bao-hiem
  - iBHXH
...
iBHXH là cổng khai báo BHXH điện tử chính thức của BHXH Việt Nam. Doanh nghiệp **bắt buộc** nộp hồ sơ tham gia/điều chỉnh BHXH qua đây thay vì nộp giấy. HRM phải xuất đúng định dạng XML/file theo chuẩn iBHXH. Chu kỳ hàng tháng, deadline trước ngày 25 tháng sau. Phân hệ liên quan: Bảo hiểm → iBHXH Portal → BHXH Việt Nam.

## Mermaid Flow

```mermaid
flowchart TD
    A[Tong hop du lieu BH thang sau khi tinh luong xong]
    B[Xac dinh bien dong BH: Tham gia moi / Dung / Dieu chinh luong]
    C[Doi soat C70 voi D02: khop danh sach va muc luong]
    D{C70 khop voi D02?}
    FIX[Dieu chinh du lieu trong HRM]
    E[HRM sinh file D02-TS chuan iBHXH]
    F[Ke toan BH upload len cong iBHXH deadline ngay 25]
    G[Nhan ma tiep nhan ho so tu iBHXH]
    H[Theo doi trang thai duyet 3-7 ngay lam viec]
    I{Ket qua duyet?}
    J[Hop le: Luu ket qua vao HRM va doi soat C70]
    K[Tu choi: Xem ly do sua va nop lai]
