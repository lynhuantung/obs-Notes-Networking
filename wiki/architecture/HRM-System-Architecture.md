---
description: "Kiến trúc tổng quan hệ thống HRM với Kubernetes, microservices, .NET 8, thiết kế cho dự án VnPay quy mô lớn."
type: architecture
tags:
  - architecture
  - kubernetes
...
> **Phạm vi**: HRM .NET 8 — kiến trúc production (VnPay case study)
