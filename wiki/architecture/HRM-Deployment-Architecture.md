---
description: "Kiến trúc triển khai HRM trên IIS, Kubernetes, Docker với multi-tenant và cấu trúc thư mục S3."
type: architecture
tags:
  - deployment
  - iis
...
## K8s Deployment (Chi tiết — dùng chung mọi dự án)

Tài liệu lập kế hoạch K8s đầy đủ (sizing, network, checklist, service info):
- [[wiki/sources/p9k2w-deploy-k8s-hrm-planning]] — Bộ 10 file kế hoạch triển khai K8s
- [[wiki/architecture/p9k2w-k8s-hrm-service-architecture]] — Sơ đồ 8 service + network zones
- [[wiki/flows/m3t7x-flow-cicd-deploy-k8s]] — Luồng CI (VNR) / CD (KH)
- [[wiki/flows/v2k9m-flow-golive-k8s]] — Quy trình go-live 7 phase
