---
description: "Nhật ký 24 vấn đề kỹ thuật hệ thống HRM (IIS/SQL/Log/Network) từ 2022–2026: nguyên nhân, giải pháp và bài học cho triển khai và vận hành."
type: source
tags:
  - hrm
  - iis
...
# Nhật Ký Vấn Đề Hệ Thống — HRM

> Nguồn: `0. Daily/2026-Apr-17/Nhat-ky-van-de-he-thong.md` | 22 vấn đề kỹ thuật hệ thống (Sys000–Sys022)

## Tóm tắt

Tài liệu ghi nhận 22 vấn đề kỹ thuật phát sinh trong quá trình triển khai và vận hành HRM, được đội SE tích lũy từ 2022–2025. Mỗi vấn đề trình bày theo cấu trúc: Hiện trạng → Nguyên nhân → Phương án. Các vấn đề tập trung vào 4 nhóm chính: IIS/Pool, SQL Server, Log & Monitoring, và Network/Security.
