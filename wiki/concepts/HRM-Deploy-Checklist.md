---
description: "Checklist triển khai HRM: kiểm tra IIS, SQL Server, network, code quality trước và sau khi deploy."
type: concept
tags:
  - hrm
  - deploy
...
> Ghi chú nguyên tử: checklist triển khai HRM trên server mới và checklist upbuild. Tổng hợp từ các lỗi lặp lại nhiều nhất.
