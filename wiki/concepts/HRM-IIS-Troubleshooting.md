---
description: "Hướng dẫn xử lý sự cố IIS cho HRM: App Pool crash, lỗi startup, memory leak và các bước chẩn đoán."
type: concept
tags:
  - hrm
  - iis
...
> Ghi chú nguyên tử: các lỗi IIS thường gặp khi triển khai HRM, nhóm theo pattern.
