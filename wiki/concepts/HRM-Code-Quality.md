---
description: "Quy tắc và bài học đúc kết về chất lượng code HRM: merge, store procedure, enum và các lỗi thường gặp."
type: concept
tags:
  - hrm
  - code-quality
...
> Ghi chú nguyên tử: các quy tắc và bài học về chất lượng code trong dự án HRM, đúc kết từ lỗi lặp lại.
