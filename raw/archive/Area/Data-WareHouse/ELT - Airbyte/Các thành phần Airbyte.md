...
1. **[[raw/archive/Area/Data-WareHouse/ELT - Airbyte/Sources]]**: ÄÃ¢y lÃ  nÆ¡i thiáº¿t láº­p cÃ¡c nguá»“n dá»¯ liá»‡u (vÃ­ dá»¥: SQL Server, MySQL, API) mÃ  báº¡n muá»‘n trÃ­ch xuáº¥t.

2. **[[raw/archive/Area/Data-WareHouse/ELT - Airbyte/Destinations]]**: NÆ¡i thiáº¿t láº­p Ä‘Ã­ch Ä‘áº¿n cá»§a dá»¯ liá»‡u (data warehouse, cÆ¡ sá»Ÿ dá»¯ liá»‡u hoáº·c dá»‹ch vá»¥ lÆ°u trá»¯ nhÆ° Snowflake, BigQuery) Ä‘á»ƒ náº¡p dá»¯ liá»‡u sau khi xá»­ lÃ½.

3. **[[raw/archive/Area/Data-WareHouse/ELT - Airbyte/Connection]]**: ÄÃ¢y lÃ  nÆ¡i quáº£n lÃ½ cÃ¡c káº¿t ná»‘i giá»¯a nguá»“n vÃ  Ä‘Ã­ch. Báº¡n cÃ³ thá»ƒ theo dÃµi tráº¡ng thÃ¡i cá»§a tá»«ng káº¿t ná»‘i, thá»i gian Ä‘á»“ng bá»™, vÃ  cÃ¡c cÃ i Ä‘áº·t liÃªn quan.

4. **[[raw/archive/Area/Data-WareHouse/ELT - Airbyte/Builder]]**: TÃ­nh nÄƒng nÃ y cho phÃ©p táº¡o connector tÃ¹y chá»‰nh náº¿u Airbyte khÃ´ng cÃ³ sáºµn loáº¡i nguá»“n hoáº·c Ä‘Ã­ch báº¡n cáº§n. 
