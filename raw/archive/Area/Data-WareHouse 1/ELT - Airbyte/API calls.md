...
### PhÃ¢n trang khi gá»i api
---
- Xá»­ lÃ½ api phÃ¢n trang  theo pageSize, pageIndex
- [[raw/archive/Area/Data-WareHouse 1/ELT - Airbyte/Paging-builder]]

### Gia háº¡n token cho API
- Cho phÃ©p cáº¥u hÃ¬nh thá»i gian háº¿t háº¡n token tá»« webSetting cá»§a api service
