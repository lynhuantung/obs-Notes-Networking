...
Liên kết:
  - "[[raw/archive/1. Projects/Dự án 2026/QuickPack-Project/DailyNotes/issue-nguon-luc-se-qpvn|Issue: Thiếu nguồn lực SE]]"
  - "[[raw/archive/1. Projects/Dự án 2026/QuickPack-Project/DailyNotes/decision-chan-ky-tu-dac-biet-ma-field|Decision: Chặn ký tự đặc biệt trường MÃ]]"
  - "[[raw/archive/1. Projects/Dự án 2026/QuickPack-Project/DailyNotes/issue-server-infrastructure-qpvn|Issue: Server & Hạ tầng]]"
  - "[[raw/archive/1. Projects/Dự án 2026/QuickPack-Project/DailyNotes/task-tracking-phan-he-qpvn|Task theo Phân hệ]]"
---
...
| Ghi chú | Nội dung |
|---------|----------|
| [[raw/archive/1. Projects/Dự án 2026/QuickPack-Project/DailyNotes/issue-nguon-luc-se-qpvn\|Issue: Thiếu nguồn lực SE]] | Timeline leo thang, số MM, bài học |
| [[raw/archive/1. Projects/Dự án 2026/QuickPack-Project/DailyNotes/decision-chan-ky-tu-dac-biet-ma-field\|Decision: Chặn ký tự đặc biệt]] | 2 giải pháp → chọn GP1, cách triển khai |
| [[raw/archive/1. Projects/Dự án 2026/QuickPack-Project/DailyNotes/issue-server-infrastructure-qpvn\|Issue: Server & Hạ tầng]] | Server UAT, lỗi API, lỗi IIS, Redis |
| [[raw/archive/1. Projects/Dự án 2026/QuickPack-Project/DailyNotes/task-tracking-phan-he-qpvn\|Task theo Phân hệ]] | 8 phân hệ, đợt UAT, bug block |
