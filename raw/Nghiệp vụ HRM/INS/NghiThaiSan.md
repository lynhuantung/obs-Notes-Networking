...
```mermaid
flowchart TD
    A([NLĐ chuẩn bị nghỉ thai sản]) --> B{Đối tượng?}

    B -- Lao động nữ sinh con --> C{Đã đóng BHXH\nít nhất 6 tháng\ntrong 12 tháng trước?}
    B -- Lao động nam\nvợ sinh con --> G[Kiểm tra:\nĐang đóng BHXH]
    B -- Nhận nuôi\ncon nuôi < 6 tháng --> H[Kiểm tra:\nĐang đóng BHXH]
    B -- Tránh thai --> I[Xác nhận\nbiện pháp y tế]

    C -- Không --> C1{Sinh non < 28 tuần\nhoặc thai chết lưu?}
    C1 -- Có + đóng ≥ 3 tháng --> D
    C1 -- Không --> C2[Không được hưởng\ntrợ cấp thai sản\nChỉ hưởng trợ cấp 1 lần]
    C -- Có --> D[Đủ điều kiện\nhưởng thai sản]
    ...
    E -- Lao động nữ\nsinh thường --> E1[6 tháng]
    E -- Sinh đôi trở lên --> E2[6 tháng + 1 tháng/con\nkể từ con thứ 2]
    E -- Lao động nam\nvợ sinh thường --> E3[5 ngày làm việc]
    E -- Lao động nam\nvợ sinh PT/non --> E4[7-14 ngày làm việc]
    E -- Nhận nuôi --> E5[Đến khi con\nđủ 6 tháng tuổi]
    E -- Đặt vòng --> E6[7 ngày]
    E -- Triệt sản --> E7[15 ngày]

    E1 & E2 & E3 & E4 & E5 & E6 & E7 --> F[Tính mức trợ cấp:\n100% × Bình quân lương\n6 tháng đóng BHXH]

    F --> J[HR thu thập hồ sơ]
    J --> K[Lập danh sách\ntheo mẫu BHXH]
    K --> L[Nộp hồ sơ lên\nCơ quan BHXH]
    L --> M{BHXH duyệt?}
...
## 7. Xử lý trong phần mềm HRM (HRM / Bizzi)
